...
<head>
    ...
    <title>Dean of Students Dashboard — Brown University</title>
    <style>
    ...
    <div style="display:flex;align-items:center;gap:12px">
        <div class="topbar-right">
            <div>
                ...
                <div class="staff-sub">Dean of Students</div>
            </div>
...
<div class="content">
    <div class="page-title">Dean of Students Dashboard</div>
    <div class="page-sub">Manage student clearance requests and conduct records.</div>
    ...
    <div class="stats">
        ...
        <div class="stat">
            <div class="stat-num" style="color:#ef4444">{{ $openRecords }}</div>
            <div class="stat-label">Open Conduct Records</div>
        </div>
        <div class="stat">
            <div class="stat-num" style="color:#185FA5">{{ $totalStudents }}</div>
            <div class="stat-label">Total Students</div>
        </div>
        <div class="stat">
            <div class="stat-num" style="color:#16a34a">{{ $resolvedRecords }}</div>
            <div class="stat-label">Resolved Records</div>
        </div>
        <div class="stat">
    ...
    <div class="tab-content active" id="tab-pending">
        <div class="card">
            ...
            <div class="student-row">
                ...
                <a href="{{ route('dean.student', $clearance->user->id) }}" class="btn-view">View →</a>
            </div>
            @empty
